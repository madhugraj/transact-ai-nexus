...
export const PreviewTab: React.FC<PreviewTabProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Ensure Tabs has an explicit defaultValue that matches a TabsContent value */}
      <Tabs value={activeTab} onValueChange={setActiveTab} defaultValue={activeTab || "document"}>
